        ...
        authenticate("auth-jwt") {
            authorization(setOf(roleAdmin)) {
                ...
                post {
                    ...
                    if(parsingData.find().toList().isEmpty()) {
                        ...
                        call.respondText("Documents in MongoDB were successfully added", status = HttpStatusCode.OK)
                    }
                    else {
                        call.respondText("Documents in MongoDB have already been added",
                ...
                delete {
                    if(parsingData.find().toList().isNotEmpty()) {
                        ...
                        call.respondText("Documents from MongoDB were successfully deleted",
                            status = HttpStatusCode.OK)
                    }
                    else {
                        call.respondText("Documents from MongoDB have already been deleted",
                            status = HttpStatusCode.BadRequest)
                    }
                }
                ...
                delete("{id}") {
                    ...
                    if(parsingData.findOne(Payload::id eq id) != null) {
                        ...
                        call.respondText("The document from MongoDB was successfully deleted", status = HttpStatusCode.OK)
                    }
                    else {
            ...
            authorization(roleList.toSet()) {
                ...
                get("table/{id}") {
                    ...
                    } ?: call.respondText("The element for this ID was not found",
